            ...
            Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  itemDivider,
                  _buildItem(icon: CustomIcons.version, title: '当前版本', onPressed: _checkVersion, trailingTips: Global.version),
                ],
              ),
            ),
          ],
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            ...
            Utils.expanded(),
            trailingTips != null ? Text('v$trailingTips  ', style: TextStyle(fontSize: a.px17, color: Colors.grey)) : Container(),
